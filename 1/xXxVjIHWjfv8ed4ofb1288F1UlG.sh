...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxqeBzaJGxqvJbaOfB7CTRlqpC.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxVjIHWjfv8ed4ofb1288F1UlG.py 1/xXxVjIHWjfv8ed4ofb1288F1UlG_model.txt --top_p 0.1 --temperature 0.34 --apply_quality_control 'False' --hugging_face False
