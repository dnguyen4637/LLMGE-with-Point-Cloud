...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxaDbRsiuPEgtQkSkkrhkkvedt.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXx7PphQSUcBuNTli1djJBwHKTo.py 1/xXx7PphQSUcBuNTli1djJBwHKTo_model.txt --top_p 0.1 --temperature 0.1 --apply_quality_control 'False' --hugging_face False
