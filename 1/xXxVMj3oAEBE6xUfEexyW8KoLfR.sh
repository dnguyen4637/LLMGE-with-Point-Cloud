...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxpq3sL0XQvVvUZyXoLGnOSUNd.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxVMj3oAEBE6xUfEexyW8KoLfR.py 1/xXxVMj3oAEBE6xUfEexyW8KoLfR_model.txt --top_p 0.1 --temperature 0.06 --apply_quality_control 'False' --hugging_face False
