...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxBgRETx4t6MJPwr9MdQva9b0I.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxRMrRsugxqwis20KUcZ7i9954.py 1/xXxRMrRsugxqwis20KUcZ7i9954_model.txt --top_p 0.1 --temperature 0.11 --apply_quality_control 'False' --hugging_face False
