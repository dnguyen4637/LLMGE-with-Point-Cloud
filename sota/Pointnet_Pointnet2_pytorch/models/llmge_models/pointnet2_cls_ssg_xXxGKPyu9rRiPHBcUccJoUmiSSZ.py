...
class GetLoss(nn.Module):
    ...
    def forward(self, pred, target, trans_feat):
        ...
        # Add the new loss term based on the mean value
        new_loss = F.relu(mean_trans_feat - 0.5) * 0.1

        # Combine the original and new loss terms
        final_loss = total_loss + new_loss
