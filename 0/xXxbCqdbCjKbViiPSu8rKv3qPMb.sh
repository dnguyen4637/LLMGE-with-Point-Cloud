...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxQ5Pj0PyscBJvrPR0wYYywuQi.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxbCqdbCjKbViiPSu8rKv3qPMb.py 0/xXxbCqdbCjKbViiPSu8rKv3qPMb_model.txt --top_p 0.1 --temperature 0.15 --apply_quality_control 'False' --hugging_face False
