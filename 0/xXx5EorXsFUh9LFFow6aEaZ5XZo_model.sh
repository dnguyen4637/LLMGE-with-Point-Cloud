...
# Run Python script
PYTHONPATH=/home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models:$PYTHONPATH python ./sota/Pointnet_Pointnet2_pytorch/train_classification.py --batch_size 216 --model "pointnet2_cls_ssg_xXx5EorXsFUh9LFFow6aEaZ5XZo" --data /storage/ice-shared/vip-vvk/data/llm_ge_data/modelnet40_normal_resampled --end_lr 0.001 --seed 21 --val_r 0.2 --amp --epoch 2
