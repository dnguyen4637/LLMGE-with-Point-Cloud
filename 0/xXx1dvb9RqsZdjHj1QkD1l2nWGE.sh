...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxjz45tZroXWIZlBOwRF2TcSjd.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXx1dvb9RqsZdjHj1QkD1l2nWGE.py 0/xXx1dvb9RqsZdjHj1QkD1l2nWGE_model.txt --top_p 0.1 --temperature 0.19 --apply_quality_control 'False' --hugging_face False
