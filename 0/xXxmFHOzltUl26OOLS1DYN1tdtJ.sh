...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXx98ispPgjO8XHtmRyK4lofvip.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxmFHOzltUl26OOLS1DYN1tdtJ.py 0/xXxmFHOzltUl26OOLS1DYN1tdtJ_model.txt --top_p 0.1 --temperature 0.09 --apply_quality_control 'False' --hugging_face False
