...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxvdYBKysqyVV4PLW8iI4bHMm2.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxTquzbxzDOQPGaiyAwiZvqOYZ.py 0/xXxTquzbxzDOQPGaiyAwiZvqOYZ_model.txt --top_p 0.1 --temperature 0.14 --apply_quality_control 'False' --hugging_face False
