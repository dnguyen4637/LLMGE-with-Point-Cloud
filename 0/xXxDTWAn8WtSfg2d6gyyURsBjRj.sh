...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxzsPf7oBFr1tSSqrnar8EIcfU.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxDTWAn8WtSfg2d6gyyURsBjRj.py 0/xXxDTWAn8WtSfg2d6gyyURsBjRj_model.txt --top_p 0.1 --temperature 0.3 --apply_quality_control 'False' --hugging_face False
