...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxtzTtvuX3FTyn1F9k6AMiST27.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxM4NucbZMv6Dje3u3en6sUlTq.py 0/xXxM4NucbZMv6Dje3u3en6sUlTq_model.txt --top_p 0.1 --temperature 0.22 --apply_quality_control 'False' --hugging_face False
