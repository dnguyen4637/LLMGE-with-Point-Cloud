...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxPGiTvy4quMeZjhhacERkKRGd.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxOwFuqaR1P2NckPOg6FjA9a9l.py 0/xXxOwFuqaR1P2NckPOg6FjA9a9l_model.txt --top_p 0.1 --temperature 0.22 --apply_quality_control 'False' --hugging_face False
