...
# Run Python script
python src/llm_mutation.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxy0WeasW0AEaxr3AHLXNnUObe.py /home/hice1/dnguyen448/scratch/LLM-Guided-Evolution-Generic/sota/Pointnet_Pointnet2_pytorch/models/llmge_models/pointnet2_cls_ssg_xXxQHz23vC9gpjHsfVhcWnkf331.py 0/xXxQHz23vC9gpjHsfVhcWnkf331_model.txt --top_p 0.1 --temperature 0.18 --apply_quality_control 'False' --hugging_face False
